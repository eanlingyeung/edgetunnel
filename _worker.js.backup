...
let userID = '26d30a57-09c0-4be8-ad54-b93671f3ceec';

let proxyIP = '';// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org, cdn-all.xn--b6gac.eu.org, workers.cloudflare.cyou'

let sub = 'sub.cmliussss.net';// 避免项目被滥用，现已取消内置订阅器
let subconverter = 'SUBAPI.cmliussss.net';// clash订阅转换后端，目前使用CM的订阅转换功能。自带虚假uuid和host订阅。
